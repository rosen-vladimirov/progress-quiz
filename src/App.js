...
function App(args) {
  ...
  const surveyJson = {
    ...
    "logoWidth": 60,
    "logoHeight": 60,
    completedHtml: `<h3>Thank you for completing the quiz! We'll select our winner at PUT DATE HERE and we'll contact you through the provided email if you are the winner.</h3>`,
    hideNumbers: true,
    pages: [
      {
        elements: [
